...
class Argument:
    ...
    VM_IP = {"name_or_flags": ["--vm-ip"], "options": {"action": "store", "help": "IP of the vm"}}
    VM_MAC = {
    ...
    ESX_IP = {"name_or_flags": ["--esx-ip"], "options": {"action": "store", "help": "Esx ip"}}
    ESX_NAME_REGEX = {
        "name_or_flags": ["--esx-name-regex"],
        "options": {"action": "store", "help": "Esx name regex"},
    }
    DNS_NAME = {"name_or_flags": ["--dns-name"], "options": {"action": "store", "help": "DNS name"}}
    NAME = {
    ...
    VLAN_ID = {"name_or_flags": ["--vlan-id"], "options": {"action": "store", "help": "Vlan ID"}}
    DEVICE_NAME = {
