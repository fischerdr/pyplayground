...
import typer
from src.utils.ansible_tower_utils import get_awx_or_tower_client, list_resources
...
def export(
    ...
    :param verify: Boolean flag indicating whether to verify the connection to Tower.
    """
    try:
