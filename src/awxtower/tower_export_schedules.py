...
@app.command()
def export(
    tower_host: str = typer.Option("https://tower.example.com", help="Tower host URL"),
    tower_token: str = typer.Option("YOUR_TOWER_TOKEN", help="Tower API token"),
    output: str = typer.Option("schedules.json", help="Output JSON file path"),
) -> None:
