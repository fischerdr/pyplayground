...
def build_full_traversal():
    ...
    dc_to_hf.selectSet.extend((selection_spec(name="visitFolders"),))

    # Traversal through vmFolder branch
    dc_to_vmf = traversal_spec(name="dcToVmf", type=vim.Datacenter, path="vmFolder", skip=False)
    dc_to_vmf.selectSet.extend((selection_spec(name="visitFolders"),))
