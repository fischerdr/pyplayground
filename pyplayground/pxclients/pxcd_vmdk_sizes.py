...
This script will also execute into a portworx pod and run the pxctl command to get the
current storagecluster sizes and used sizes.
...
from pyplayground.utils.px_api import get_cloud_drive_config  # Needed to read the configmap data
from pyplayground.utils.vmware_utils import connect, extract_path_from_datastore_path
