...
def import_schedules(
    awx_host: str = typer.Option("https://awx.example.com", help="AWX host URL"),
    awx_token: str = typer.Option("YOUR_AWX_TOKEN", help="AWX API token"),
    input_file: str = typer.Option("schedules.json", help="Input JSON file path"),
) -> None:
